<%@ Page Title="Student Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentDetails.aspx.cs" Inherits="ASPLesson_4.StudentDetails" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="form-group">
                    <label class="control-label" for="EnrollmentDateTextBox">Last Name</label>
